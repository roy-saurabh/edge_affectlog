...
class Tenant(Base):
    ...
    quota: Mapped[TenantQuota | None] = relationship(
        "TenantQuota", back_populates="tenant", uselist=False
    )
    ...
    support_grants: Mapped[list[SupportAccessGrant]] = relationship(
        "SupportAccessGrant", back_populates="tenant", cascade="all, delete-orphan"
    )
    smtp_settings: Mapped[TenantSmtpSettings | None] = relationship(
        "TenantSmtpSettings", back_populates="tenant", uselist=False
    )
    storage_policy: Mapped[TenantStoragePolicy | None] = relationship(
        "TenantStoragePolicy", back_populates="tenant", uselist=False
    )
